...
def get_snowpark_session() -> Session:
    ...
    elif os.path.exists(os.path.expanduser('~/Documents/github/sfguide-data-engineering-with-snowpark-python/.snowsql/config')):
...
def get_snowsql_config(
 ...
 #   config_file_path: str = os.path.expanduser('~/.snowsql/config'),
    config_file_path: str = os.path.expanduser('~/Documents/github/sfguide-data-engineering-with-snowpark-python/.snowsql/config'),
) -> dict:
    import configparser
